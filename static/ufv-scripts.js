...
var sensitivity = parseInt(document.getElementById("slider_sensitivity").value);
var waterpressure = parseInt(document.getElementById("slider_waterpressure").value);
